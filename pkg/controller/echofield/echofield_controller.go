...
import (
	...
	trialv1alpha1 "github.com/cstoku/kubebuilder-test-controller/pkg/apis/trial/v1alpha1"
...
// Add creates a new EchoField Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
// and Start it when the Manager is Started.
// USER ACTION REQUIRED: update cmd/manager/main.go to call this trial.Add(mgr) to install this Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileEchoField{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
var _ reconcile.Reconciler = &ReconcileEchoField{}

// ReconcileEchoField reconciles a EchoField object
type ReconcileEchoField struct {
	client.Client
	scheme *runtime.Scheme
}

// Reconcile reads that state of the cluster for a EchoField object and makes changes based on the state read
// and what is in the EchoField.Spec
